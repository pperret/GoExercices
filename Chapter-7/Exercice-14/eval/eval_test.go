...
func TestEval(t *testing.T) {
	tests := []struct {
		...
		{"-1 - x", Env{"x": 1}, "-2"},
		//!+Eval
		{"sum{X, Y*3, Z}/count{X, Y, Z*3}", Env{"X": 100, "Y": 20, "Z": 20}, "60"},
		{"avg{X, Y*3, Z}", Env{"X": 100, "Y": 20, "Z": 20}, "60"},
		{"min{X, Y*3, Z}", Env{"X": 100, "Y": 20, "Z": 20}, "20"},
		{"max{X, Y*3, Z}", Env{"X": 100, "Y": 20, "Z": 20}, "100"},
	}
	var prevExpr string
