...
// lexer is a text scanner saving the current lookahead token
// (not available in the standard implementation of scanner).
type lexer struct {
...
// precedence returns the level of an operator
